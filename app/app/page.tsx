...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        pearsonCorrelation: correlationData.pearsonCorrelation || 0,
        chiSquareTest: oscarAwardsData || [],
      });
  ...
  const handleTrendSubmit = async (evt: React.FormEvent) => {
    ...
    try {
      ...
      setStats(prev => ({ ...prev, genreSuccessTrend: trendData }));
      setSelectedGenre(formGenre);
      setSelectedDecade(formDecade);
      setError(null);
    } catch (err: any) {
    ...
    try {
      ...
      setStats(prev => ({
        ...
        actorProfile: {
          ...
          avgRating: data.reduce((sum: number, m: any) => sum + m.rating, 0) / data.length || 0,
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
              ...
              {trendLoading ? (
                ...
                <div className="h-64 flex flex-col items-center justify-center text-gray-400 text-sm space-y-2">
                  ...
                  <p className="text-xs">Try: Genre: "Action" or "Drama", Decade: "2010"</p>
                </div>
              )}
            </div>
          </div>
